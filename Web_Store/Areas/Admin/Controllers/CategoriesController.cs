...
namespace Web_Store.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        {
            if (page == null) page = 1;
            var Category = (from l in db.Categories
                          select l).OrderBy(x => x.CategoryId);
            int pageSize = 15;
        ...
        public ActionResult Create([Bind(Include = "CategoryId,Name,Introduce")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryId,Name,Introduce")] Category category)
        {
            if (ModelState.IsValid)
            {
